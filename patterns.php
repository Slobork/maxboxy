    ...
    add_action(
        'init', function () {
            ...
            register_block_pattern(
                ...
                'categories'    => ['maxboxy-infoboxes'],
                'content'       => "<!-- wp:group {\"style\":{\"border\":{\"top\":{\"width\":\"4px\"}},\"color\":{\"text\":\"#38b265\",\"background\":\"#e0ffec\"},\"spacing\":{\"padding\":{\"top\":\"20px\",\"right\":\"20px\",\"bottom\":\"20px\",\"left\":\"20px\"}}},\"className\":\"is-style-default\",\"layout\":{\"type\":\"flex\",\"flexWrap\":\"nowrap\",\"justifyContent\":\"left\",\"verticalAlignment\":\"top\"}} -->
                <div class=\"wp-block-group is-style-default has-text-color has-background\" style=\"border-top-width:4px;color:#38b265;background-color:#e0ffec;padding-top:20px;padding-right:20px;padding-bottom:20px;padding-left:20px\"><!-- wp:html -->
                <svg style=\"width: 3em;display: block;fill: #38b265;\" xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 512 512\"><path d=\"M256 73.82a182.18 182.18 0 1 0 0 364.36c100.608 0 182.18-81.571 182.18-182.18S356.608 73.82 256 73.82zm-1.512 265.333c-15.662 0-28.354-13.456-28.354-30.067h56.703c0 16.611-12.695 30.067-28.349 30.067zm26.306-45.87h-52.62c-1.42-15.495-38.232-28.995-38.232-67.71 0-41.291 30.885-63.185 64.538-64.011h.008c33.654.826 64.53 22.72 64.53 64.01.004 38.716-36.81 52.216-38.224 67.711z\" data-name=\"Tips On\"></path></svg>
                <!-- /wp:html -->
                
                <!-- wp:group {\"style\":{\"color\":{\"text\":\"#0b321a\"},\"spacing\":{\"padding\":{\"left\":\"0px\",\"top\":\"0px\",\"right\":\"0px\",\"bottom\":\"0px\"}}},\"layout\":{\"type\":\"constrained\",\"justifyContent\":\"center\"}} -->
                <div class=\"wp-block-group has-text-color\" style=\"color:#0b321a;padding-top:0px;padding-right:0px;padding-bottom:0px;padding-left:0px\"><!-- wp:paragraph -->
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Diam sit amet nisl suscipit adipiscing bibendum est ultricies. Sit amet aliquam id diam maecenas ultricies mi. Viverra suspendisse potenti nullam ac tortor vitae purus faucibus. Elit duis tristique sollicitudin nibh.</p>
                <!-- /wp:paragraph --></div>
                <!-- /wp:group --></div>
                <!-- /wp:group -->",
            ...
            register_block_pattern(
                ...
                'categories'    => ['maxboxy-infoboxes'],
                'content'       => "<!-- wp:group {\"style\":{\"border\":{\"top\":{\"width\":\"4px\"}},\"color\":{\"text\":\"#f0b849\",\"background\":\"#fef8ee\"},\"spacing\":{\"padding\":{\"top\":\"20px\",\"right\":\"20px\",\"bottom\":\"20px\",\"left\":\"20px\"}}},\"className\":\"is-style-default\",\"layout\":{\"type\":\"flex\",\"flexWrap\":\"nowrap\",\"justifyContent\":\"left\",\"verticalAlignment\":\"top\"}} -->
                <div class=\"wp-block-group is-style-default has-text-color has-background\" style=\"border-top-width:4px;color:#f0b849;background-color:#fef8ee;padding-top:20px;padding-right:20px;padding-bottom:20px;padding-left:20px\"><!-- wp:html -->
                <svg style=\"width: 3em;display: block;fill: #f0b849;\" xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 512 512\"><path d=\"M256 73.825a182.175 182.175 0 1 0 182.18 182.179A182.182 182.182 0 0 0 256 73.824zm-.791 288.79a18.897 18.897 0 1 1 18.905-18.897 18.901 18.901 0 0 1-18.905 18.898zm23.466-83.47a22.047 22.047 0 0 1-44.094 0V162.595a22.047 22.047 0 1 1 44.094 0z\" data-name=\"Warning\"></path></svg>
                <!-- /wp:html -->
                
                <!-- wp:group {\"style\":{\"color\":{\"text\":\"#2e2506\"},\"spacing\":{\"padding\":{\"left\":\"0px\",\"top\":\"0px\",\"right\":\"0px\",\"bottom\":\"0px\"}}},\"layout\":{\"type\":\"constrained\",\"justifyContent\":\"center\"}} -->
                <div class=\"wp-block-group has-text-color\" style=\"color:#2e2506;padding-top:0px;padding-right:0px;padding-bottom:0px;padding-left:0px\"><!-- wp:paragraph -->
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Diam sit amet nisl suscipit adipiscing bibendum est ultricies. Sit amet aliquam id diam maecenas ultricies mi. Viverra suspendisse potenti nullam ac tortor vitae purus faucibus. Elit duis tristique sollicitudin nibh.</p>
                <!-- /wp:paragraph --></div>
                <!-- /wp:group --></div>
                <!-- /wp:group -->",
            ...
            register_block_pattern(
                ...
                'categories'    => ['maxboxy-infoboxes'],
                'content'       => "<!-- wp:group {\"style\":{\"border\":{\"top\":{\"width\":\"4px\"}},\"color\":{\"text\":\"#eb0d16\",\"background\":\"#f7e9ed\"},\"spacing\":{\"padding\":{\"top\":\"20px\",\"right\":\"20px\",\"bottom\":\"20px\",\"left\":\"20px\"}}},\"className\":\"is-style-default\",\"layout\":{\"type\":\"flex\",\"flexWrap\":\"nowrap\",\"justifyContent\":\"left\",\"verticalAlignment\":\"top\"}} -->
                <div class=\"wp-block-group is-style-default has-text-color has-background\" style=\"border-top-width:4px;color:#eb0d16;background-color:#f7e9ed;padding-top:20px;padding-right:20px;padding-bottom:20px;padding-left:20px\"><!-- wp:html -->
                <svg style=\"width: 3em;display: block;fill: #eb0d16;\" xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 512 512\"><g data-name=\"Stop\"><path d=\"M210.798 323.773A81.103 81.103 0 0 0 323.35 211.22zM256 175.282a81.078 81.078 0 0 0-63.685 131.335l113.88-113.872A80.69 80.69 0 0 0 256 175.282z\"></path><path d=\"M256 73.82c-100.616 0-182.179 81.572-182.179 182.172C73.821 356.6 155.383 438.18 256 438.18c100.61 0 182.18-81.572 182.18-182.188 0-100.61-81.571-182.172-182.18-182.172zm0 288.94a106.339 106.339 0 1 1 106.339-106.338A106.458 106.458 0 0 1 256 362.761z\"></path></g></svg>
                <!-- /wp:html -->
                
                <!-- wp:group {\"style\":{\"color\":{\"text\":\"#3e1e1e\"},\"spacing\":{\"padding\":{\"left\":\"0px\",\"top\":\"0px\",\"right\":\"0px\",\"bottom\":\"0px\"}}},\"layout\":{\"type\":\"constrained\",\"justifyContent\":\"center\"}} -->
                <div class=\"wp-block-group has-text-color\" style=\"color:#3e1e1e;padding-top:0px;padding-right:0px;padding-bottom:0px;padding-left:0px\"><!-- wp:paragraph -->
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Diam sit amet nisl suscipit adipiscing bibendum est ultricies. Sit amet aliquam id diam maecenas ultricies mi. Viverra suspendisse potenti nullam ac tortor vitae purus faucibus. Elit duis tristique sollicitudin nibh.</p>
                <!-- /wp:paragraph --></div>
                <!-- /wp:group --></div>
                <!-- /wp:group -->",
            ...
            register_block_pattern(
                ...
                'content'       => "<!-- wp:group {\"style\":{\"border\":{\"top\":{\"width\":\"4px\"}},\"color\":{\"text\":\"#eb0d16\",\"background\":\"#f7e9ed\"},\"spacing\":{\"padding\":{\"top\":\"20px\",\"right\":\"20px\",\"bottom\":\"20px\",\"left\":\"20px\"}}},\"className\":\"is-style-default\",\"layout\":{\"type\":\"flex\",\"flexWrap\":\"nowrap\",\"justifyContent\":\"left\",\"verticalAlignment\":\"top\"}} -->
                <div class=\"wp-block-group is-style-default has-text-color has-background\" style=\"border-top-width:4px;color:#eb0d16;background-color:#f7e9ed;padding-top:20px;padding-right:20px;padding-bottom:20px;padding-left:20px\"><!-- wp:html -->
                <svg style=\"width: 3em;display: block;fill: #eb0d16;\" xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 512 512\"><g data-name=\"Shield Off\"><path d=\"m228.782 218.655-16.101 16.111 27.21 27.21-27.21 27.203 16.101 16.11 27.211-27.211 27.215 27.211 16.107-16.11-27.221-27.203 27.221-27.21-16.107-16.111-27.215 27.22-27.211-27.22z\"></path><path d=\"M255.993 73.82c-100.608 0-182.17 81.571-182.17 182.18 0 100.6 81.562 182.18 182.17 182.18 100.613 0 182.185-81.571 182.185-182.18S356.606 73.82 255.993 73.82zm.01 282.85c-93.746 0-100.424-158.616-100.424-158.616l100.414-42.733h.01l100.414 42.733s-6.68 158.616-100.415 158.616z\"></path></g></svg>
                <!-- /wp:html -->
