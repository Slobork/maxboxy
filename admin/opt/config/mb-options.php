...
if (! defined('ABSPATH')) {
    ...
    $toggler_basic_tab  = array(
        ...
        array(
            ...
            'options'       => array(
                'pos1'          => plugins_url('maxboxy/admin/opt/img/pos-1.png'),
                'pos2'          => plugins_url('maxboxy/admin/opt/img/pos-2.png'),
                'pos3'          => plugins_url('maxboxy/admin/opt/img/pos-3.png'),
                'pos4'          => plugins_url('maxboxy/admin/opt/img/pos-4.png'),
                'pos5'          => plugins_url('maxboxy/admin/opt/img/pos-5.png'),
                'pos6'          => plugins_url('maxboxy/admin/opt/img/pos-6.png'),
                'pos7'          => plugins_url('maxboxy/admin/opt/img/pos-7.png'),
                'pos8'          => plugins_url('maxboxy/admin/opt/img/pos-8.png'),
                'pos9'          => plugins_url('maxboxy/admin/opt/img/pos-9-cent.png'),
                'pos10'         => plugins_url('maxboxy/admin/opt/img/pos-10-cent.png'),
                'pos11'         => plugins_url('maxboxy/admin/opt/img/pos-11-cent.png'),
                'pos12'         => plugins_url('maxboxy/admin/opt/img/pos-12-cent.png'),
            ),
            'default'       => 'pos1',
            'dependency'    => array('unset_toggler','!=','all'),
        ),
