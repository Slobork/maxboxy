<?php
	...
	add_action('init', function() {
		...
		register_block_pattern_category(
			'maxboxy-buttons',  array( 'label' => esc_html__( 'MaxBoxy: Buttons', 'maxboxy' ) )
		);
		
		register_block_pattern_category(
			'maxboxy-contact', array( 'label' => esc_html__( 'MaxBoxy: Contact', 'maxboxy' ) )
		);

		register_block_pattern_category(
			'maxboxy-cookies', array( 'label' => esc_html__( 'MaxBoxy: Cookies & GDPR', 'maxboxy' ) )
		);
		
		register_block_pattern_category(
			'maxboxy-cta', array( 'label' => esc_html__( 'MaxBoxy: CTA', 'maxboxy' ) )
		);
		
		/* planned
		register_block_pattern_category(
			'maxboxy-gallery',  array( 'label' => esc_html__( 'MaxBoxy: Gallery', 'maxboxy' ) )
		);
		*/
		
		register_block_pattern_category(
			'maxboxy-media', array( 'label' => esc_html__( 'MaxBoxy: Media', 'maxboxy' ) )
		);

		/* planned
		register_block_pattern_category(
			'maxboxy-menus',  array( 'label' => esc_html__( 'MaxBoxy: Menus', 'maxboxy' ) )
		);
		*/
		
		// options only with pro
		register_block_pattern_category(
			'maxboxy-promo', array( 'label' => esc_html__( 'MaxBoxy: Promo', 'maxboxy' ) )
		);
		
		register_block_pattern_category(
			'maxboxy-signups', array( 'label' => esc_html__( 'MaxBoxy: Signups', 'maxboxy' ) )
		);
	...
	add_action('init', function() {
		...
		// button 1
		register_block_pattern('maxboxy/button-pc', [
			...
			'content'       => "<!-- wp:buttons -->
								...
								<div class=\"wp-block-button mboxy-closer\"><a class=\"wp-block-button__link\">Close me</a></div>
								<!-- /wp:button --></div>
								<!-- /wp:buttons -->",
		]);

		// button 2
		register_block_pattern('maxboxy/button-pt', [
			'title'         => esc_html__('Panel toggler', 'maxboxy'),
			'keywords'      => ['button'],
			'categories'    => ['maxboxy-buttons'],
			'content'       => "<!-- wp:buttons -->
								<div class=\"wp-block-buttons\"><!-- wp:button {\"className\":\"mboxy-toggler\"} -->
								<div class=\"wp-block-button mboxy-toggler\"><a class=\"wp-block-button__link\">Toggle me</a></div>
								<!-- /wp:button --></div>
								<!-- /wp:buttons -->",
		]);
		...
		// Contact 1
		register_block_pattern('maxboxy/contact-cfwsi', [
			'title'         => esc_html__('Contact form with social icons', 'maxboxy'),
			'keywords'      => ['contact', 'contact us'],
			'categories'    => ['maxboxy-contact'],

			// put in the modal on the page load - https://github.com/WordPress/gutenberg/pull/41791
			//'blockTypes' 	=> array( 'core/post-content' ),
			// ...for specified post types - will work with Gutenberg plugin active, integration planned from wp 6.1
		...
		// Contact 2
		register_block_pattern('maxboxy/contact-cfegmpeasi', [
		...
		// Contact 3
		register_block_pattern('maxboxy/contact-cfegmsiwacb', [
		...
		// Cookies - 1
		register_block_pattern('maxboxy/cookies-1', [
		...
		// Cookies - 2
		register_block_pattern('maxboxy/cookies-2', [
		...
		// Cookies - 3
		register_block_pattern('maxboxy/cookies-3', [
		...
		// Cookies - 4
		register_block_pattern('maxboxy/cookies-4', [
		...
		// Cookies - 5
		register_block_pattern('maxboxy/cookies-5', [
		...
		// CTA 1
		register_block_pattern('maxboxy/cta-cctag', [
		...
		// CTA 2
		register_block_pattern('maxboxy/cta-ctapc', [
		...
		// CTA 3
		register_block_pattern('maxboxy/cta-ctapbpfbi', [
		...
		// media 1
		register_block_pattern('maxboxy/media-cmgycati', [
		...
		// media 2
		register_block_pattern('maxboxy/media-emycatiwbc', [
		...
		// Signup 1
		register_block_pattern('maxboxy/signup-cng', [
		...
		// Signup 2
		register_block_pattern('maxboxy/signup-iacb', [
		...
		// Signup 3
		register_block_pattern('maxboxy/signup-iacbwi', [
	...
	}, 5); // 5 - higher priority than default, so it loads before the patterns added by the Pro plugin
