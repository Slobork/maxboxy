<?php
	 ...
	 * Loading - Inject Any.
	 */
	CSF::createMetabox( '_mb_injectany_loading', array(
	...
	CSF::createSection( '_mb_injectany_loading', array(
	 ...
	 * Loading - Float Any.
	 */
	CSF::createMetabox( '_mb_floatany_loading', array(
		'title'     =>  esc_html__( 'Loading', 'maxboxy' ),
	...
	CSF::createSection( '_mb_floatany_loading', array(
		'fields' => array(
			$field_auto_loading,
			$auto_loading_splitter_info,
			array(
	 ...
	 */
	CSF::createMetabox( '_mb_floatany', array(
	...
	CSF::createSection( '_mb_floatany', array(
		'fields' => array(
	 ...
	 */
	CSF::createMetabox( '_mb_injectany', array(
		'title'       => esc_html__( 'Type & style', 'maxboxy' ),
	  ...
	  CSF::createSection( '_mb_injectany', array(
		  'fields' => array(
	 ...
	 * Conversion.
	 */
	CSF::createMetabox( '_mb_maxboxy_conversion', array(
	...
	CSF::createSection( '_mb_maxboxy_conversion', array(
			'fields' => array(
	 ...
	 * latter this condition should be omitted and plugin inactive mesages left to $mb_splitter_info.
	 */
	if ( class_exists( 'Max__Boxy__Splitter' ) ) {
		 ...
		 * Splitter info.
		 */
		CSF::createMetabox( '_mb_maxboxy_splitter_info', array(
			'title'       => esc_html__( 'Splitter (A/B Testing)', 'maxboxy' ),
			'post_type'   =>  array_merge( array( 'inject_any', 'float_any' ), $add_reusable_blocks ),
			'context'     =>  'side',
			) );
			
			CSF::createSection( '_mb_maxboxy_splitter_info', array(
	 ...
	 */
	CSF::createMetabox( '_mb_maxboxy_conditionals', array(
	...
	CSF::createSection( '_mb_maxboxy_conditionals', array(
	 ...
	 * Splitter.
	 */
	CSF::createMetabox( '_mb_maxboxy_splitter', array(
	...
	CSF::createSection( '_mb_maxboxy_splitter', array(
	...
	CSF::createMetabox( '_mb_maxboxy_splitter_loading', array(
		'title'    		=> esc_html__( 'Loading', 'maxboxy' ),
		'post_type'		=>  array( 'maxboxy_splitter' ),
		'context'     	=>  'normal',
		'data_type'		=> 'unserialize',
	...
	CSF::createSection( '_mb_maxboxy_splitter_loading', array(
		'fields' => array(
			array(
				'type'   	=> 'content',
