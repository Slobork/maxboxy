    ...
    $toggler_basic_tab  = array(
        ...
        array(
            ...
            'options'       => array(
                ...
                'svg-basket-+'      => plugins_url('maxboxy/admin/opt/img/svg-basket.png'),
                'svg-basket-+2'     => plugins_url('maxboxy/admin/opt/img/svg-basket.png'),
                'svg-book'          => plugins_url('maxboxy/admin/opt/img/svg-book.png'),
                'svg-cookie'        => plugins_url('maxboxy/admin/opt/img/svg-cookie.png'),
                'svg-cookie-2'      => plugins_url('maxboxy/admin/opt/img/svg-cookie.png'),
                'svg-chat'          => plugins_url('maxboxy/admin/opt/img/svg-chat.png'),
                'svg-chat-2'        => plugins_url('maxboxy/admin/opt/img/svg-chat.png'),
                'svg-chat-3'        => plugins_url('maxboxy/admin/opt/img/svg-chat.png'),
                'svg-chat-4'        => plugins_url('maxboxy/admin/opt/img/svg-chat.png'),
                'svg-chat-5'        => plugins_url('maxboxy/admin/opt/img/svg-chat.png'),
                'svg-chats'         => plugins_url('maxboxy/admin/opt/img/svg-chats.png'),
                'svg-chats-2'       => plugins_url('maxboxy/admin/opt/img/svg-chats.png'),
                'svg-chats-3'       => plugins_url('maxboxy/admin/opt/img/svg-chats.png'),
                'svg-app'           => plugins_url('maxboxy/admin/opt/img/svg-eye.png'),
                'svg-app-2'         => plugins_url('maxboxy/admin/opt/img/svg-eye.png'),
                'svg-elipsis-h'     => plugins_url('maxboxy/admin/opt/img/svg-flag.png'),
                'svg-elipsis-v'     => plugins_url('maxboxy/admin/opt/img/svg-call.png'),
                'svg-home'          => plugins_url('maxboxy/admin/opt/img/svg-home.png'),
                'svg-home-2'        => plugins_url('maxboxy/admin/opt/img/svg-home.png'),
                'svg-info'          => plugins_url('maxboxy/admin/opt/img/svg-info.png'),
                'svg-location'      => plugins_url('maxboxy/admin/opt/img/svg-location.png'),
                'svg-location-2'    => plugins_url('maxboxy/admin/opt/img/svg-location.png'),
                ...
                'svg-share-2'       => plugins_url('maxboxy/admin/opt/img/svg-share.png'),
                'svg-plus'          => plugins_url('maxboxy/admin/opt/img/svg-plus.png'),
                'svg-plus-2'        => plugins_url('maxboxy/admin/opt/img/svg-plus.png'),
            ),
            'default'       => 'no',
        ...
        array(
            ...
            'options'       => array(
                'no'                => plugins_url('maxboxy/admin/opt/img/svg-none.png'),
                'svg-basket'        => plugins_url('maxboxy/admin/opt/img/svg-basket.png'),
                'svg-basket-x'      => plugins_url('maxboxy/admin/opt/img/svg-basket.png'),
                'svg-basket--'      => plugins_url('maxboxy/admin/opt/img/svg-basket.png'),
                'svg-book'          => plugins_url('maxboxy/admin/opt/img/svg-book.png'),
                'svg-cookie'        => plugins_url('maxboxy/admin/opt/img/svg-cookie.png'),
                'svg-cookie-2'      => plugins_url('maxboxy/admin/opt/img/svg-cookie.png'),
                ...
                'svg-share'         => plugins_url('maxboxy/admin/opt/img/svg-share.png'),
                'svg-share-2'       => plugins_url('maxboxy/admin/opt/img/svg-share.png'),
                'svg-minus'         => plugins_url('maxboxy/admin/opt/img/svg-close.png'),
                'svg-minus-2'       => plugins_url('maxboxy/admin/opt/img/svg-close.png'),
                'svg-close'         => plugins_url('maxboxy/admin/opt/img/svg-close.png'),
                'svg-close-2'       => plugins_url('maxboxy/admin/opt/img/svg-close.png'),
            ),
            'default'       => 'no',
