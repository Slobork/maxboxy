...
if (! defined('ABSPATH')) {
	 ...
	 * checking Max__Boxy__Track::enabled() won't work here, probably due order priority.
	 */
	...
	/**
	 * Differentiate options availabe on the basic & the pro version - For Splitter metabox
	 */
	...
	// if the pro plugin isn't active
		...
		// there's no splitter free version, this is just to bypass the error notices when the splitter plugin isn't active
		$mb_splitter = array(
	...
	$toggler_basic_tab  = array(
		...
		/* this option will need improvment - offering a couple of more optopns - set with select field
		array(
			'id'            => 'trigger_anim',
			'type'          => 'checkbox',
